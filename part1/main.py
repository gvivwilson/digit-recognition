...
#######################################################################
# 2. Linear Regression with Closed. Y Form Solution
#######################################################################
...
# print('softmax test_error=', run_softmax_on_MNIST(temp_parameter=0.1))
...
print("Test error for softmax_pca= ", run_softmax_on_MNIST_pca(temp_parameter=1))
...
#
# theta, cost_history = softmax_regression(train_cube, train_y, temp_parameter=1, alpha=0.3,
#                                          lambda_factor=1.0e-4, k=10, num_iterations=150)
# test_error = compute_test_error(test_cube, test_y, theta, temp_parameter=1)
# print('Test error softmax_cube=', test_error)
